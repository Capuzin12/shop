...
import api from '../../../api';
import { mapZodErrors } from '../../../shared/utils/validation';
import { z } from 'zod';
...
export default function ResetPassword() {
  ...
  // Додано стани для відображення паролів
              ...
              <span className="mb-1 block text-sm font-medium text-slate-600 dark:text-slate-300">
                ...
                <div className="relative">
                  <input
                      ...
                      required
                      className={`form-input pr-10 ${fieldErrors.new_password ? 'form-input-error' : ''}`}
                  />
                  <button
                      type="button"
                ...
                {fieldErrors.new_password ? <p className="form-error-text">{fieldErrors.new_password}</p> : null}
              </label>

              <label className="block">
              <span className="mb-1 block text-sm font-medium text-slate-600 dark:text-slate-300">
                Підтвердіть пароль<span className="required-mark">*</span>
              </span>
                <div className="relative">
                  <input
                      ...
                      required
                      className={`form-input pr-10 ${fieldErrors.confirm_password ? 'form-input-error' : ''}`}
                  />
                  <button
                      type="button"
                ...
                {fieldErrors.confirm_password ? <p className="form-error-text">{fieldErrors.confirm_password}</p> : null}
              </label>
            </div>

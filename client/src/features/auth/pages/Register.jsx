...
import api from '../../../api';
import { mapZodErrors, registerSchema } from '../../../shared/utils/validation';
          ...
          <form noValidate onSubmit={handleSubmit} className="rounded-[2.5rem] border border-white/50 bg-white/75 p-8 shadow-xl shadow-amber-100/40 backdrop-blur dark:border-white/10 dark:bg-slate-900/60 dark:shadow-none">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <label className="block">
                <span className="mb-1 block text-sm font-medium text-slate-600 dark:text-slate-300">Імʼя<span className="required-mark">*</span></span>

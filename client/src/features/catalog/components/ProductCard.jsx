...
export default function ProductCard({ product, viewConfig, liked, onToggleWishlist, onAddToCart }) {
    ...
    return (
        <div
            className={`group flex h-full flex-col rounded-[2rem] border border-white/50 bg-white/80 ${viewConfig.cardPadding} shadow-lg shadow-amber-100/30 transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-slate-900/70 dark:shadow-none cursor-pointer`}
            ...
            <div className="mt-auto space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    <Link
                        ...
                        className="rounded-2xl border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:text-slate-200 dark:hover:bg-white/5"
                    >
                        Деталі
                    </Link>
                    <button

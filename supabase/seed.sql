...
INSERT INTO public.users (
    id, email, password_hash, first_name, last_name, phone, role, customer_group_id, is_active, created_at, updated_at
      ...
      (7, 'ivan.kravets@gmail.com', '$2b$12$nug/FW0yHn2ybr0qbjRqWuJyUVYfFhQXutE3WeGri7hFt/YVlB712', 'Іван', 'Кравець', '+380671234555', 'customer', 1, true, '2026-06-01 08:05:00', '2026-06-01 08:05:00');
...
INSERT INTO public.addresses (
    id, user_id, label, city, street, building, apartment, postal_code, is_default, created_at
      ...
      (10, 7, 'Офіс', 'Київ', 'вул. Ревуцького', '24', '7', '02091', true, '2026-06-01 08:10:00');
...
INSERT INTO public.supply_orders (
    id, supplier_id, invoice_number, status, total_amount, notes, ordered_at, expected_at, received_at, created_by, created_at
      ...
      (5, 1, 'INV-2026-0601', 'received', 11980.00, 'Червневе поповнення популярних позицій для тесту аналітики.', '2026-06-01 09:00:00', '2026-06-04 18:00:00', '2026-06-01 12:30:00', 3, '2026-06-01 09:00:00');
...
INSERT INTO public.orders (
    ...
    payment_method, payment_status, promo_code_id, comment, admin_note, created_at, updated_at
      ...
      (7, 7, 10, 'Іван Кравець', '+380671234555', 'ivan.kravets@gmail.com', 'Київ', 'вул. Ревуцького, 24, кв. 7',
       'delivered', 4120.00, 150.00, 0.00, 4270.00, 'nova_poshta', 'NP59000111224455',
       'card_online', 'paid', NULL, 'Доставку бажано після обіду.', 'Червневе тестове замовлення для аналітики.', '2026-06-01 13:00:00', '2026-06-01 13:30:00'),

      (8, 5, 5, 'Олег Терновий', '+380931234999', 'oleh.ternovyi@gmail.com', 'Львів', 'вул. Зелена, 149',
       'picked_up', 1890.00, 0.00, 0.00, 1890.00, 'pickup', NULL,
       'bank_transfer', 'paid', NULL, 'Самовивіз для об''єкта.', 'Другий червневий тестовий чек для аналітики.', '2026-06-01 14:00:00', '2026-06-01 14:20:00');
...
INSERT INTO public.order_items (
    id, order_id, product_id, product_name, product_sku, quantity, unit_price
      ...
      (14, 7, 1, 'Штукатурка гіпсова Knauf Rotband 30кг', 'KNF-SHP-30', 6, 329.00),
      (15, 7, 28, 'Ґрунтівка Ceresit CT 17 10л', 'CER-CT17-10', 2, 780.00),

      (16, 8, 13, 'Гідроізоляція Ceresit CR 65 25кг', 'CER-CR65-25', 1, 1249.00),
      (17, 8, 24, 'Рівень будівельний 1000мм', 'TLS-RIV-1000', 1, 420.00);
...
INSERT INTO public.inventory_movements (
    id, product_id, supply_order_id, order_id, type, quantity, quantity_before, quantity_after, note, created_by, created_at
      ...
      (12, 1, 5, NULL, 'receipt', 25, 98, 123, 'Червневе поповнення по накладній INV-2026-0601.', 3, '2026-06-01 12:35:00'),
      (13, 28, 5, NULL, 'receipt', 30, 58, 88, 'Надходження ґрунтівки для тесту аналітики.', 3, '2026-06-01 12:38:00'),
      (14, 24, NULL, NULL, 'adjustment', -2, 37, 35, 'Ручна інвентаризаційна корекція.', 3, '2026-06-01 15:10:00'),
      (15, 29, NULL, NULL, 'write_off', -1, 50, 49, 'Списання пошкодженого пакування.', 3, '2026-06-01 15:15:00'),
      (16, 1, NULL, 7, 'sale', -6, 123, 117, 'Відвантаження по замовленню #7.', 3, '2026-06-01 13:20:00'),
      (17, 28, NULL, 7, 'sale', -2, 88, 86, 'Комплектація замовлення #7.', 3, '2026-06-01 13:22:00'),
      (18, 13, NULL, 8, 'sale', -1, 26, 25, 'Самовивіз по замовленню #8.', 3, '2026-06-01 14:25:00');

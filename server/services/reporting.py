...
def collect_admin_report_data(db: Session) -> dict[str, Any]:
    ...
    return {"generated_at": generated_at, "counts": counts, "total_stock_units": total_stock_units, "low_stock_rows": low_stock_rows, "out_of_stock_rows": out_of_stock_rows, "status_counts": status_counts, "paid_revenue": paid_revenue, "latest_orders": latest_orders, "top_products": top_products}
